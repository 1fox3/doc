...
- [x] [278. First Bad Version（简单）](https://leetcode.cn/problems/first-bad-version/)
- [x] [374. Guess Number Higher or Lower（简单）](https://leetcode.cn/problems/guess-number-higher-or-lower/)
- [x] [704. Binary Search（简单）](https://leetcode.cn/problems/binary-search/)
...
- [x] [111. Minimum Depth of Binary Tree（简单）](https://leetcode.cn/problems/minimum-depth-of-binary-tree/)
- [x] [144. Binary Tree Preorder Traversal（简单）](https://leetcode.cn/problems/binary-tree-preorder-traversal/)
- [x] [145. Binary Tree Postorder Traversal（简单）](https://leetcode.cn/problems/binary-tree-postorder-traversal/)
- [x] [637. Average of Levels in Binary Tree（简单）](https://leetcode.cn/problems/average-of-levels-in-binary-tree/)
...
- [x] [199. Binary Tree Right Side View（中等）](https://leetcode.cn/problems/binary-tree-right-side-view/)
- [x] [515. Find Largest Value in Each Tree Row（中等）](https://leetcode.cn/problems/find-largest-value-in-each-tree-row/)
- 复盘：
...
- [x] [110. Balanced Binary Tree（简单）](https://leetcode.cn/problems/balanced-binary-tree/)
- [x] [226. Invert Binary Tree（简单）](https://leetcode.cn/problems/invert-binary-tree/)
- [x] [543. Diameter of Binary Tree（简单）](https://leetcode.cn/problems/diameter-of-binary-tree/)
- [x] [572. Subtree of Another Tree（简单）](https://leetcode.cn/problems/subtree-of-another-tree/)
