# LeetCode 30 天打卡表（Hot 100 向）

> 规则建议：每天 3~4 题；完成后打 ✅；错题在“复盘”里记录一行原因。

## Day 1（哈希入门：Map 计数、去重、快速查找）
- [x] [1. Two Sum（简单）](https://leetcode.cn/problems/two-sum/)
- [x] [217. Contains Duplicate（简单）](https://leetcode.cn/problems/contains-duplicate/)
- [x] [242. Valid Anagram（简单）](https://leetcode.cn/problems/valid-anagram/)
- [x] [350. Intersection of Two Arrays II（简单）](https://leetcode.cn/problems/intersection-of-two-arrays-ii/)
- [x] [383. Ransom Note（简单）](https://leetcode.cn/problems/ransom-note/)
- [x] [49. Group Anagrams（中等）](https://leetcode.cn/problems/group-anagrams/)
- [x] [128. Longest Consecutive Sequence（中等）](https://leetcode.cn/problems/longest-consecutive-sequence/)
- [x] [347. Top K Frequent Elements（中等）](https://leetcode.cn/problems/top-k-frequent-elements/)
- [x] [454. 4Sum II（中等）](https://leetcode.cn/problems/4sum-ii/)
- [x] [525. Contiguous Array（中等）](https://leetcode.cn/problems/contiguous-array/)
- 复盘：对于347学习到了PriorityQueue(作为堆)和Comparator的使用。

## Day 2（双指针：对撞指针与快慢指针）
- [x] [26. Remove Duplicates from Sorted Array（简单）](https://leetcode.cn/problems/remove-duplicates-from-sorted-array/)
- [x] [27. Remove Element（简单）](https://leetcode.cn/problems/remove-element/)
- [x] [88. Merge Sorted Array（简单）](https://leetcode.cn/problems/merge-sorted-array/)
- [x] [125. Valid Palindrome（简单）](https://leetcode.cn/problems/valid-palindrome/)
- [x] [283. Move Zeroes（简单）](https://leetcode.cn/problems/move-zeroes/)
- [x] [344. Reverse String（简单）](https://leetcode.cn/problems/reverse-string/)
- [x] [11. Container With Most Water（中等）](https://leetcode.cn/problems/container-with-most-water/)
- [x] [15. 3Sum（中等）](https://leetcode.cn/problems/3sum/)
- [x] [167. Two Sum II - Input Array Is Sorted（中等）](https://leetcode.cn/problems/two-sum-ii-input-array-is-sorted/)
- [x] [18. 4Sum（中等）](https://leetcode.cn/problems/4sum/)
- 复盘：

## Day 3（滑动窗口：定长/不定长窗口维护）
- [x] [643. Maximum Average Subarray I（简单）](https://leetcode.cn/problems/maximum-average-subarray-i/)
...
- [x] [209. Minimum Size Subarray Sum（中等）](https://leetcode.cn/problems/minimum-size-subarray-sum/)
- [x] [424. Longest Repeating Character Replacement（中等）](https://leetcode.cn/problems/longest-repeating-character-replacement/)
- [x] [438. Find All Anagrams in a String（中等）](https://leetcode.cn/problems/find-all-anagrams-in-a-string/)
- [x] [560. Subarray Sum Equals K（中等）](https://leetcode.cn/problems/subarray-sum-equals-k/)
...
## Day 6（链表基础：反转、合并、判环）
- [x] [21. Merge Two Sorted Lists（简单）](https://leetcode.cn/problems/merge-two-sorted-lists/)
- [x] [83. Remove Duplicates from Sorted List（简单）](https://leetcode.cn/problems/remove-duplicates-from-sorted-list/)
- [x] [141. Linked List Cycle（简单）](https://leetcode.cn/problems/linked-list-cycle/)
- [ ] [160. Intersection of Two Linked Lists（简单）](https://leetcode.cn/problems/intersection-of-two-linked-lists/)
- [ ] [203. Remove Linked List Elements（简单）](https://leetcode.cn/problems/remove-linked-list-elements/)
- [ ] [206. Reverse Linked List（简单）](https://leetcode.cn/problems/reverse-linked-list/)
- [ ] [234. Palindrome Linked List（简单）](https://leetcode.cn/problems/palindrome-linked-list/)
- [x] [19. Remove Nth Node From End of List（中等）](https://leetcode.cn/problems/remove-nth-node-from-end-of-list/)
- [ ] [24. Swap Nodes in Pairs（中等）](https://leetcode.cn/problems/swap-nodes-in-pairs/)
- [ ] [148. Sort List（中等）](https://leetcode.cn/problems/sort-list/)
- 复盘：

## Day 7（链表进阶：删除、交换、随机指针）
- [x] [61. Rotate List（中等）](https://leetcode.cn/problems/rotate-list/)
- [x] [82. Remove Duplicates from Sorted List II（中等）](https://leetcode.cn/problems/remove-duplicates-from-sorted-list-ii/)
- [x] [86. Partition List（中等）](https://leetcode.cn/problems/partition-list/)
- [x] [92. Reverse Linked List II（中等）](https://leetcode.cn/problems/reverse-linked-list-ii/)
- [ ] [138. Copy List with Random Pointer（中等）](https://leetcode.cn/problems/copy-list-with-random-pointer/)
- [ ] [142. Linked List Cycle II（中等）](https://leetcode.cn/problems/linked-list-cycle-ii/)
...
- [x] [496. Next Greater Element I（简单）](https://leetcode.cn/problems/next-greater-element-i/)
- [x] [402. Remove K Digits（中等）](https://leetcode.cn/problems/remove-k-digits/)
- [x] [503. Next Greater Element II（中等）](https://leetcode.cn/problems/next-greater-element-ii/)
- [x] [739. Daily Temperatures（中等）](https://leetcode.cn/problems/daily-temperatures/)
- [ ] [901. Online Stock Span（中等）](https://leetcode.cn/problems/online-stock-span/)
- [ ] [907. Sum of Subarray Minimums（中等）](https://leetcode.cn/problems/sum-of-subarray-minimums/)
- [ ] [962. Maximum Width Ramp（中等）](https://leetcode.cn/problems/maximum-width-ramp/)
...
## Day 10（二分查找：边界与旋转数组）
- [x] [35. Search Insert Position（简单）](https://leetcode.cn/problems/search-insert-position/)
- [x] [69. Sqrt(x)（简单）](https://leetcode.cn/problems/sqrtx/)
- [ ] [278. First Bad Version（简单）](https://leetcode.cn/problems/first-bad-version/)
- [ ] [374. Guess Number Higher or Lower（简单）](https://leetcode.cn/problems/guess-number-higher-or-lower/)
- [ ] [704. Binary Search（简单）](https://leetcode.cn/problems/binary-search/)
- [x] [33. Search in Rotated Sorted Array（中等）](https://leetcode.cn/problems/search-in-rotated-sorted-array/)
...
- [ ] [153. Find Minimum in Rotated Sorted Array（中等）](https://leetcode.cn/problems/find-minimum-in-rotated-sorted-array/)
- [ ] [162. Find Peak Element（中等）](https://leetcode.cn/problems/find-peak-element/)
- [ ] [4. Median of Two Sorted Arrays（困难）](https://leetcode.cn/problems/median-of-two-sorted-arrays/)
- 复盘：

## Day 11（二叉树遍历：递归与层序）
- [x] [94. Binary Tree Inorder Traversal（简单）](https://leetcode.cn/problems/binary-tree-inorder-traversal/)
- [x] [104. Maximum Depth of Binary Tree（简单）](https://leetcode.cn/problems/maximum-depth-of-binary-tree/)
...
- [ ] [637. Average of Levels in Binary Tree（简单）](https://leetcode.cn/problems/average-of-levels-in-binary-tree/)
- [x] [102. Binary Tree Level Order Traversal（中等）](https://leetcode.cn/problems/binary-tree-level-order-traversal/)
- [x] [107. Binary Tree Level Order Traversal II（中等）](https://leetcode.cn/problems/binary-tree-level-order-traversal-ii/)
- [ ] [199. Binary Tree Right Side View（中等）](https://leetcode.cn/problems/binary-tree-right-side-view/)
- [ ] [515. Find Largest Value in Each Tree Row（中等）](https://leetcode.cn/problems/find-largest-value-in-each-tree-row/)
- 复盘：

## Day 12（二叉树性质：对称、直径、翻转）
- [x] [100. Same Tree（简单）](https://leetcode.cn/problems/same-tree/)
- [x] [101. Symmetric Tree（简单）](https://leetcode.cn/problems/symmetric-tree/)
- [ ] [110. Balanced Binary Tree（简单）](https://leetcode.cn/problems/balanced-binary-tree/)
- [ ] [226. Invert Binary Tree（简单）](https://leetcode.cn/problems/invert-binary-tree/)
- [ ] [543. Diameter of Binary Tree（简单）](https://leetcode.cn/problems/diameter-of-binary-tree/)
- [ ] [572. Subtree of Another Tree（简单）](https://leetcode.cn/problems/subtree-of-another-tree/)
- [ ] [965. Univalued Binary Tree（简单）](https://leetcode.cn/problems/univalued-binary-tree/)
...
- [x] [108. Convert Sorted Array to Binary Search Tree（简单）](https://leetcode.cn/problems/convert-sorted-array-to-binary-search-tree/)
- [x] [530. Minimum Absolute Difference in BST（简单）](https://leetcode.cn/problems/minimum-absolute-difference-in-bst/)
