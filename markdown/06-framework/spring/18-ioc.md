...
- 建议优先掌握：Inversion of Control, 好处。
- 二级节点提示了主要拆分角度：控制反转, 降低组件之间的耦合度, 管理对象的生命周期, 提高代码的可测试性, 提高代码的可维护性, 方便实现切面编程。
- 三级节点通常对应具体细节、API、机制或易错点：将创建对象的控制权进行转移，有Spring IOC进行负责创建对象，装配对象，配置对象，管理对象之间的依赖关系，并且管理这些对象的整个生命周期。

### 复习追问

- `Inversion of Control` 解决什么问题？核心机制是什么？有什么常见坑或替代方案？
- `好处` 解决什么问题？核心机制是什么？有什么常见坑或替代方案？
